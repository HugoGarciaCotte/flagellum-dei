          ...
          messages: [
            {
              role: "user",
              content:
                "Generate a square app icon (512x512) for a tabletop RPG helper app called 'Prima TRPG'. A golden shield with crossed swords on a dark #141318 background, warm parchment and gold tones, clean and bold for mobile home screens. No text whatsoever. Fantasy style, simple silhouette.",
            },
          ],
